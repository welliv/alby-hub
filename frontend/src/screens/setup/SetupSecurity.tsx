        ...
        <div className="flex flex-col gap-6 w-full mt-6">
          ...
          store.nodeInfo.backendType === "PHOENIX" ? (
            <div className="flex gap-3 items-center">
              ...
              <span className="text-sm text-muted-foreground">
                Channel backups{" "}
                <span className="underline">are not handled</span>
                by Alby Hub. Please take care of your own backups or go back and
            ...
            <div className="flex gap-3 items-center">
              ...
              <span className="text-sm text-muted-foreground">
                ...
                balance can be recovered only with your 12-word recovery phrase
                which you can access once your node has started.
